...
namespace CrossCutting.Mietmaschinendatenbank_DataClasses
{
    ...
    public partial class Maschinenart: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Lagerbestand> Lagerbestand
        {
            get
            {
                if (_lagerbestand == null)
                {
                    _lagerbestand = new TrackableCollection<Lagerbestand>();
                    _lagerbestand.CollectionChanged += FixupLagerbestand;
                }
        ...
        private TrackableCollection<Lagerbestand> _lagerbestand;
        ...
        private void FixupLagerbestand(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Lagerbestand item in e.NewItems)
                {
                    item.Maschinenart = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        if (!item.ChangeTracker.ChangeTrackingEnabled)
                        {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Lagerbestand", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Lagerbestand item in e.OldItems)
                {
                    if (ReferenceEquals(item.Maschinenart, this))
                    {
                        item.Maschinenart = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Lagerbestand", item);
                    }
                }
            }
        }
